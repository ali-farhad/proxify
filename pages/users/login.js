          ...
          <form onSubmit={handleSubmit}  className="grid grid-cols-6 gap-12 mt-8">
            ...
            <div className="col-span-6">
              ...
              <input
                ...
                className="w-full mt-1 border-2 px-2  h-full text-gray-700 bg-white border-softBlue rounded-md shadow-sm"
              />
            </div>
            ...
            <div className="col-span-6 sm:col-span-6">
              ...
              <input
                ...
                className=" w-full mt-1 h-full px-2 text-gray-700 bg-white border-softBlue border-2 rounded-md shadow-sm"
              />
            </div>
