        ...
        <form onSubmit={handleSubmit}  className="grid grid-cols-6 gap-12 mt-8">
          <div className="col-span-6 sm:col-span-6">
            ...
            <input
              ...
              className=" w-full mt-1 h-full text-gray-700 bg-white border-softBlue border-2 px-2 rounded-md shadow-sm"
            />
          </div>
          ...
          <div className="col-span-6">
            ...
            <input
              ...
              className="w-full mt-1  h-full text-gray-700 bg-white border-2 px-2 border-softBlue rounded-md shadow-sm"
            />
          </div>
          ...
          <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
            ...
            type="submit"
            value="Register"
              className="inline-block px-12 py-3 text-lg font-medium text-white transition bg-softBlue border border-blue-600 rounded-md shrink-0 hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500"
            />            
